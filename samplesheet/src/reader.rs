...
///
/// Uses [super::SampleSheetBuilder] under the hood. [Header](super::SampleSheetHeader), [Reads](super::SampleSheetReads), [Settings](super::SampleSheetSettings), and
    ...
    while !slice.is_empty() {
        match parser::parse_section(slice) {
            Ok((i, (section, mut raw_contents))) => {
                ...
                if *section.get_kind() == SectionType::KV {
